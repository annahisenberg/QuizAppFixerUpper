const STORE = [{
    question: 'Where is Fixer Upper filmed?',
    answers: [
      'Houston, TX',
      'Dallas, TX',
      'Austin, TX',
  ...
  {
    question: 'How many kids do Chip and Joanna have?',
    answers: [
      '2',
      '3',
      '4, with another on the way',
      '5'
    ],
  ...
  {
    question: "What was the name of Chip and Joanna's first store?",
    answers: [
      'Magnolia',
      'Orchid',
      'Tulip',
  ...
  {
    question: 'When did Chip flip his first house?',
    answers: [
      'During high school',
      'During college',
      'In his mid-twenties',
  ...
  {
    question: 'What is Joanna\'s favorite way to decorate walls?',
    answers: [
      'Shiplap',
      'Lots of wood frames',
  ...
  {
    question: 'How did they get their own show?',
    answers: [
      'They just applied on HGTV\'s website - duh!',
      'HGTV approached them after they saw pictures of a recent flip house Chip and Joanna did',
      'They had a friend working at HGTV who referred them',
  ...
  {
    question: 'What style do they use most when decorating the houses?',
    answers: [
      'Modern',
      'Rustic',
      'French Country',
